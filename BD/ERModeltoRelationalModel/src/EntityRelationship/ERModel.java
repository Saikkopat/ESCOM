...
public class ERModel {
    ...
    public void addAttrToRelationship(String relName, String attach, String aName, String type) {
        ...
        if (!r.getName().equals("NULL")) {
            if (type.equalsIgnoreCase("Compuesto") || type.equalsIgnoreCase("C")) {
            ...
            } else if (type.equalsIgnoreCase("Multivalor") || type.equalsIgnoreCase("M")) {
                r.addAttribute(attach, aName, AttrType.MULTIVALUED);
            } else if (type.equalsIgnoreCase("Derviado") || type.equalsIgnoreCase("D")) {
                r.addAttribute(attach, aName, AttrType.DERIVED);
            } else {
                System.err.println("El tipo de atributo " + type + " no es compatible");
    ...
    public void addAttrToEntity(String eName, String attach, String aName, String type) {
        ...
        if (!e.getName().equals("NULL")) {
            ...
            } else if (type.equalsIgnoreCase("Derivado") || type.equalsIgnoreCase("D")) {
                e.addAttr(attach, aName, AttrType.DERIVED);
            } else {
                System.err.println("El tipo" + type + " no es compatible");
                System.err.println("Intente nuevamente.");
            }//if-else
        }//if
    }//addAttrToEntity
        ...
        try {
            for (Relationship r : relationships)
                if (r.getName().equals(name))
                    return r;
            System.err.println("No se encontro relacion " + name + "\nregresando NULL");
            throw new ElementNotFound("La relacion con el nombre " + name + " no fue encontrada");
    ...
    public String toString() {
        ...
        if (!regEntities.isEmpty()) {
            ret += "***Entidades regulares***\n\n";
            for (Entity e : regEntities)
                ret += e.toString() + "\n";
        }//if
        if (!weakEntities.isEmpty()) {
            ret += "***Entidades debiles***\n\n";
            for (Entity e : weakEntities)
                ret += e.toString() + "\n";
        }//if
