...
public class Entity {
    ...
    public void setKeyAttr(ArrayList<String> keys) {
        ...
        for (String a : keys) {
            ...
            if (in) {
                ...
                System.err.println("El atributo " + a + " no esta agregado\nAgregalo antes de configurar las llaves");
            }//if-else
        }//for-each
    }//setKeyAttr
    ...
    public EAttribute getAttr(String a) {
        try {
            ...
            System.err.println("No se encontro el atributo con nombre " + a + "\nRegresando NULL");
            throw new ElementNotFound("El atributo  " + a + " no fue encontrado");
