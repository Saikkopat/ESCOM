...
public class Relationship {
    ...
    public String toString() {
        String ret;
        ret = name + "\n= = = = = = =";
        ret = ret + "\nPrimera entidad " + leftEnt.getName() + "(" + leftEnt.getType() + ")";
        ret = ret + "\nParicipacion: " + leftPar.toString();
        ret = ret + "\nCardinalidad: " + leftCar.toString();
        ret = ret + "\n- - - - - - -";
        ret = ret + "\nSegunda entidad: " + rightEnt.getName() + "(" + rightEnt.getType() + ")";
        ret = ret + "\nParicipacion: " + rightPar.toString();
        ret = ret + "\nCardinalidad: " + rightCar.toString();
        return ret + "\n";
    }//toString
